...
//				System.out.println(img_shoes.size());
				...
				try {
					for(int j=0; j<img_onepiece.size(); j++) {
						...
						File fileSmall = new File("C:\\Works2\\Hosinsa\\src\\main\\webapp\\product\\images\\원피스\\small_"+pNumber+".jpg");
						File fileBig = new File("C:\\Works2\\Hosinsa\\src\\main\\webapp\\product\\images\\원피스\\big_"+pNumber+".jpg");
						...
						proimgSmall = "product\\images\\원피스\\small_"+pNumber+".jpg";
						proimgBig = "product\\images\\원피스\\big_"+pNumber+".jpg";
