...
//				System.out.println(img_shoes.size());
				...
				try {
					for(int j=0; j<img_shoes.size(); j++) {
						...
						File fileSmall = new File("C:\\Works2\\Hosinsa\\src\\main\\webapp\\product\\images\\신발\\small_"+pNumber+".jpg");
						File fileBig = new File("C:\\Works2\\Hosinsa\\src\\main\\webapp\\product\\images\\신발\\big_"+pNumber+".jpg");						
						...
						proimgSmall = "product\\images\\신발\\small_"+pNumber+".jpg";
						proimgBig = "product\\images\\신발\\big_"+pNumber+".jpg";
